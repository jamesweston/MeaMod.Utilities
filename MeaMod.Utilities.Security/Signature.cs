                                                 ...
                                                 string filePath)
        {
            ...
            switch (status)
            {
                case SignatureStatus.Valid:
                    resourceString = Resources.SignatureStrings.MshSignature_Valid;
                    break;
                ...
                case SignatureStatus.Incompatible:
                    ...
                    {
                        resourceString = Resources.SignatureStrings.MshSignature_Incompatible_HashAlgorithm;
                    }
                    else
                    {
                        resourceString = Resources.SignatureStrings.MshSignature_Incompatible;
                    }
                ...
                case SignatureStatus.NotSigned:
                    resourceString = Resources.SignatureStrings.MshSignature_NotSigned;
                    arg = filePath;
                    break;

                case SignatureStatus.HashMismatch:
                    resourceString = Resources.SignatureStrings.MshSignature_HashMismatch;
                    arg = filePath;
                    break;

                case SignatureStatus.NotTrusted:
                    resourceString = Resources.SignatureStrings.MshSignature_NotTrusted;
                    arg = filePath;
                    break;

                case SignatureStatus.NotSupportedFileFormat:
                    resourceString = Resources.SignatureStrings.MshSignature_NotSupportedFileFormat;
                    arg = System.IO.Path.GetExtension(filePath);

                    if (string.IsNullOrEmpty(arg))
                    {
                        resourceString = Resources.SignatureStrings.MshSignature_NotSupportedFileFormat_NoExtension;
                        arg = null;
                    }
